...
BLUE = (0, 0, 255)
YELLOW = (255, 255, 0)
HAZY_BLACK = (0, 0, 0, 250)  # Semi-transparent black
GREY = (100, 100, 100)
...
# Levels and Walls
levels = [
    # Add some challenging layouts as before
...
def draw_game():
    ...
    fog.fill(HAZY_BLACK)
    pygame.draw.circle(fog, (0, 0, 0, 0), (player_pos[0] + player_size // 2, player_pos[1] + player_size // 2), visibility_radius)
    screen.blit(fog, (0, 0))
